...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "GHoPzfNh9BoGMusuSh9hcC3ZPJUkxm7fCpLCg9R3Fyid";
        String sdkKey = "5emKMboq4F3catQsqGj2kYZNqMAvCDG6CHfi6LQ8xssG";

        //需要指定上传位置
        FaceEngine faceEngine = new FaceEngine("/home/sga/IdeaProjects/past/src/main/java/com/gitHub/past/openFace/LINUX64");
        //激活引擎
